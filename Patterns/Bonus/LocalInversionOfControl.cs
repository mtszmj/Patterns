...
{
    public static class LocalInversionOfControl
    {
    ...
    public class MyClass
    {
        ...
        public void Process(Person person)
        {
            ...
            //if (!person.Names.Any()) { }
            if (person.HasNo(p => p.Names).And.HasNo(p => p.Self.Childen)) { }
            if (person.HasSome(p => p.Names).And.HasNo(p => p.Self.Childen)) { }
        }

        public class Person
        {
            public List<string> Names = new List<string>();
            public List<Person> Childen = new List<Person>();
        }
